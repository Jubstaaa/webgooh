...
export interface Category {
  ...
  /**
   * HEX renk (örn. #6366f1) — rozet rengi.
   */
  color?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface Service {
   ...
   */
  icon: 'code' | 'smartphone' | 'palette' | 'shopping-cart' | 'search' | 'shield' | 'cloud' | 'sparkles';
  summary: string;
  content?: {
    root: {
      type: string;
...
export interface SiteSetting {
  ...
  socials?:
    | {
        platform: 'instagram' | 'facebook' | 'x' | 'linkedin' | 'youtube' | 'pinterest';
        url: string;
        id?: string | null;
      }[]
    | null;
