            ...
            <AnimatePresence>
                {showTop ? (
                    <motion.button
                        ...
                        className="border-line bg-surface/80 text-paper hover:border-brand/60 hover:text-brand-bright grid size-11 place-items-center rounded-full border backdrop-blur-md transition-colors"
